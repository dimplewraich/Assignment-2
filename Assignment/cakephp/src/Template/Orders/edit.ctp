 ...
 <div class="col-md-6">
            ...
            <h3>PERSONAL INFORMATION</h3>
			 <div class="form-group">	<label for="forename">Forename: </label>
				<input type="text" class="form-control" name="forename" id="forename" value="<?php echo $order['forename']; ?>" />
		</div>
				<div class="form-group"><label for="surname">Surname: </label>
				<input type="text" class="form-control" name="surname" id="surname" value="<?php echo $order['surname'];  ?>"/>
		</div>
				<div class="form-group"><label for="address">Address: </label>
				<input type="text" class="form-control" name="address" id="address" value="<?php echo $order['address']; ?>" />
		</div>
				<div class="form-group"><label for="city">City: </label>
				<input type="text" class="form-control" name="city" id="city"  value="<?php echo $order['city']; ?>" />
		</div>
    ...
    <label for="postalcode">Postal Code: </label>
		<input type="text"  class="form-control" name="postalcode" id="postalcode" value="<?php echo $order['postalcode'];  ?>"   />
		</div>


		<div class="form-group">	<label for="telephonenumber">Telephone Number: </label>
		<input type="text"  class="form-control"name="telephonenumber" id="phonenumber"  value="<?php echo $order['phonenumber']; ?>"  />
		</div>
		
		<div class="form-group">
		<label for="email">Email: </label>
		<input type="text"  class="form-control" name="email" id="email" value="<?php echo $order['email'];  ?>"   />
...
<input type="text" class="form-control" name="numberofpizzas" id="numberofpizzas" value="<?php echo $order['numberofpizzas'];  ?> "  /> 
</div>
